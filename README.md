...
## Dependencies
- Adonisjs6 [lucid(`@adonisjs/lucid`)](https://docs.adonisjs.com/guides/database/introduction)
- Adonisjs6 [auth(`@adonisjs/auth`)](https://docs.adonisjs.com/guides/auth/introduction)
